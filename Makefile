...
ZLIB_LIB := -DZLIB_LIBRARY="extdeps/zlib/lib/libz.dylib" -DZLIB_INCLUDE_DIR="extdeps/zlib"
PNG_LIB := -DPNG_LIBRARY="extdeps/libpng/lib/libpng16.dylib" -DPNG_INCLUDE_DIR="extdeps/libpng/include"
BZIP2_LIB := -DBZIP2_LIBRARY="extdeps/brotli/lib/libbz2.dylib" -DBZIP2_INCLUDE_DIR="extdeps/brotli/include"
HarfBuzz_LIB := -DHarfBuzz_LIBRARY="extdeps/HarfBuzz/lib/libharfbuzz.a" -DHarfBuzz_INCLUDE_DIR="extdeps/HarfBuzz/include"
...
build_dependencies:
	...
	sudo cmake -S downloads/libpng -B downloads/libpng/build -DCMAKE_BUILD_TYPE=$(BUILD_TYPE)
